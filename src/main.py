# src/main.py
"""
Основной модуль FastAPI-приложения для управления вопросами и ответами.

Содержит:
- Обработчики маршрутов (роуты) для API.
- Конфигурацию логирования.

Реализованы следующие эндпоинты:
- GET /questions/ — список всех вопросов
- POST /questions/ — создание нового вопроса
- GET /questions/{id}/ — получение вопроса и всех его ответов
- DELETE /questions/{id}/ — удаление вопроса и связанных ответов

- POST /questions/{id}/answers/ — добавление ответа к вопросу
- GET /answers/{id}/ — получение конкретного ответа
