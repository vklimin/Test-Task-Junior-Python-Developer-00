...
- [Шаг 10. Подготовка к тестированию Pytest](#шаг-10-подготовка-к-тестированию-pytest)
- [Шаг 11. Настройка логирования Logging](#шаг-11-настройка-логирования-logging)
- [Шаг 12. Создание методов API](#шаг-12-создание-методов-api)
...
### 03. Пробный запуск контейнера
* Для запуска контейнера перейдите в каталог с файлом конфигурации и выполните команду:
```bash
docker-compose up
```
> При первом запуске образ скачается - это может занять некоторое время\
> При успешном запуске появится надпись "LOG: database system is ready to accept connections"
...
## Шаг 10. Подготовка к тестированию Pytest
### 01. Добавление модуля
...
## Шаг 12. Создание эндпоинтов API
